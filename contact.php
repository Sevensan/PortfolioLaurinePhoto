...
if(!empty($_POST))
{
    ...
    $prepare = $db->prepare("INSERT INTO contact (nom, prenom, email, telephone, message) VALUES (?,?,?,?,?)");
    $prepare->execute(array($nom, $prenom, $email, $telephone, $message));
    Database::disconnect();
}
...
<body>
    ...
    ?>
    <div class="siteFormulaireContact">
    <img class="formulaireBG" src="img/tsuki.png" alt="background">
        <div class="container-fluid">
            ...
            <p class="alert-success"><?php
                if(!empty($_POST))
                {
                    echo 'Merci pour votre message ! Il sera traité dans les plus bref délais';
                }            
            ?></p>
            <form class="form" action="contact.php" method="POST" role="form">
