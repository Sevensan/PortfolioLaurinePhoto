...
<body>
    ...
    <div class="site">';
        ...
        <h2 class="btn btn-outline-light btn-lg" id="tous">Tous</h2>
        <?php
        foreach($categories as $categorie)
        {
            echo '<h2 class="btn btn-outline-light btn-lg" id="btncategorie' . $categorie['id'] . '">' . $categorie['name'] . '</h2>';
        }
        ?>
        </div>
        <div class="fondGrandeImage"></div>
         <?php   
        ...
        foreach($categories as $categorie)
        {
            ...
            {
                echo '<img class="imageGrand" src="img/' . $publication['image'] . '" id="' . $publication['titre'] . '" alt="grand' . $publication['titre'] . '">';
                echo '<div class="col-md-6 col-lg-4 col-xl-3 categorie' . $publication['categorie'] . '">
                        <div class="card bg-dark text-white flex">
                            <img class="imgPublication card-img-top" src="img/' . $publication['image'] . '" alt="' . $publication['titre'] . '">
                            <div class="card-body">
                                <h4 class="card-title">' . $publication['titre'] . '</h4>
                                <p class="card-text">' . $publication['datepublication'] . '</p>
                            </div>
                        </div>
                    </div>';
            }
  ...
  crossorigin="anonymous"></script>
    ...
    <script src="js/galerie/script.js"></script>
</body>
</html>