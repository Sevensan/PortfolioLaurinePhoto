<?php
    ...
    if(!empty($_POST['id']))
    {
        ...
        $db = Database::connect();
        $db->exec("SET CHARACTER SET utf8");
        $statement = $db->prepare("DELETE FROM formules WHERE id = ?");
...
<body>
    ...
    <div class="container admin">
        <div class="row">
            <div class="col-12">
                <h1><strong>Supprimer une formule</strong></h1>
                <br>
                <form class="form" action="deleteformules.php" method="post" role="form">
